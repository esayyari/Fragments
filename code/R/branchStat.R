...
qplot(data=cdat,mean_bl,support,color=model_condition)+facet_wrap(~DS)+geom_point(size=4)+
...
qplot(data=cdat,max_bl,support,color=model_condition)+facet_wrap(~DS)+geom_point(size=4)+
